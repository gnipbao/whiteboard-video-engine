...
def _build_parser() -> argparse.ArgumentParser:
    ...
    photo.add_argument("--line-thickness", type=int, default=1)
    ...
    render.add_argument("--line-thickness", type=int, default=1, help="Rendered stroke width. Use 1 for sketch-like output; increase only for low-res previews.")
